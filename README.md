# PFC Express Tracking API For Nodejs
PFC Express Tracking API and webhook make it easy to integrate PFC Express Tracking function into your own project. Support APIs Client Libraries for nodejs

### API key

In order to use this API, you need to generate a PFC Express Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use PFC Express Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [PFC Express Tracking API](https://www.trackingmore.com/pfcexpress-tracking.html)  to:

   *   Get PFC Express realtime tracking info of muti-carriers in one integration
   *   Provide PFC Express shipment tracking experience like Amazon
   *   Push PFC Express notifications of package update with webhook
   *   Verify PFC Express delivery exception before it is too late
